      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-xl text-white/80 mb-12 leading-relaxed font-light max-w-2xl">
            Avaliamos as medidas do seu rosto, da lente e do óculos utilizando
            Inteligência Artificial. Proporcionamos uma experiência única, com
            lentes multifocais feitas sob medida para você. Seu óculos nunca
            teve uma montagem como a nossa.
          </p>
