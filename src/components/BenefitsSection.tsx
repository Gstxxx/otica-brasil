    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      >
        ...
        <p className="text-xl text-white/80 max-w-4xl mx-auto font-light leading-relaxed">
          Na Ótica do Brasil, oferecemos as mais avançadas tecnologias em lentes
          multifocais para garantir o melhor da sua visão.
        </p>
      </div>
        ...
        {[
          {
            ...
            desc: "Lentes com tecnologia de ponta que garantem adaptação rápida e visão natural.",
            color: "from-blue-400/20 to-blue-600/20",
          },
          {
            icon: Heart,
            title: "Conforto Total",
            desc: "Eliminação de distorções e desconforto, proporcionando uso prolongado sem fadiga.",
            color: "from-purple-400/20 to-purple-600/20",
          },
          {
            icon: Star,
            title: "Qualidade Premium",
            desc: "Materiais de alta qualidade com tratamentos anti-reflexo e proteção UV.",
            color: "from-indigo-400/20 to-indigo-600/20",
          },
          {
            icon: Eye,
            title: "Adaptação Rápida",
            desc: "Design otimizado para adaptação rápida e natural, sem período de desconforto.",
          ...
          <div
            ...
            style={{
              transform: `translateY(${scrollY * (0.008 + index * 0.003)}px)`,
            }}
          >
            <div
              className={`bg-gradient-to-br ${item.color} w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              {[
                {
                  ...
                  desc: "Avaliação completa das suas necessidades visuais",
                },
                {
                  icon: Shield,
                  title: "Garantia de Qualidade",
                  desc: "Produtos com garantia e suporte pós-venda",
                },
                {
                  icon: Heart,
                  title: "Acompanhamento Contínuo",
                  desc: "Suporte durante todo o processo de adaptação",
                },
              ].map((item, index) => (
                <div key={index} className="flex items-start group">
                  ...
                  <div>
                    <h4 className="font-light text-white text-lg mb-1">
                      {item.title}
                    </h4>
          ...
          <div className="bg-gradient-to-br from-blue-500/30 to-purple-500/30 backdrop-blur-xl p-12 text-white border-l border-white/20">
            ...
            <p className="text-white/80 mb-10 font-light leading-relaxed text-lg">
              Agende uma consulta e descubra como as lentes multifocais podem
              revolucionar a sua qualidade de vida e visão.
            </p>
            <a
